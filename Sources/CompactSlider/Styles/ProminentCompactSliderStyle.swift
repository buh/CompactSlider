...
//        )
//        .foregroundColor(
//            Defaults.label.opacity(configuration.focusState.isFocused ? 1 : 0.7)
//        )
//        .background(
//            Defaults.label
//                .opacity(
//                    useGradientBackground && configuration.focusState.isFocused ? 0 : 0.075
//                )
//        )
//        .background(
//            LinearGradient(
...
//                endPoint: .trailing
//            )
//            .opacity(useGradientBackground && configuration.focusState.isFocused ? 0.2 : 0)
//        )
//        .accentColor(
